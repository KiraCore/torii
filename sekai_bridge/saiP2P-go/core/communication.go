...
type Message struct {
	...
	To         []string //message recveiver
	Data       []byte   // data
	Hash       string   // hash of whole message (used when message sent by chunks)
	TotalParts int      // chunks number
	Part       int      // current chunk number
	Last       bool     // flag if this message last
}
